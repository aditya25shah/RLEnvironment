...
TASKS: Dict[str, SupportTask] = {
    "easy_refund_renewal": SupportTask(
        ...
        grader_module="customer_support_ops_env.graders.easy_refund_renewal",
    ...
    "medium_replacement_delay": SupportTask(
        ...
        grader_module="customer_support_ops_env.graders.medium_replacement_delay",
        grader_function="grade",
    ),
    "hard_account_takeover": SupportTask(
        ...
        grader_module="customer_support_ops_env.graders.hard_account_takeover",
        grader_function="grade",
    ),
}
